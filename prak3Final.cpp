...
dataMobil *top, *tail, *cur, *newNode, *del;
int maksimalMobil = 5;
...
void pushMobil(string platNomor, string jenisMobil, string brandMobil) {
    if(isFullMobil()) {
        cout<<"Stack Full!!"<<endl;
    } else {
        if(isEmptyMobil()) {
            top = new dataMobil;
            top->platNomor = platNomor;
            top->jenisMobil = jenisMobil;
            top->brandMobil = brandMobil;
            top->prev = NULL;
            top->next = NULL;
            tail = top;
        } else {
            ...
            while (!exitDasboarMenu) {
                ...
                if(inputDasboard == 1) {
                    ...
                    while (!exitTambahUnit) {
                        ...
                        pushMobil(platNomor, jenisMobil, brandMobil);
